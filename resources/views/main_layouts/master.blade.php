...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	<!-- Flaticons  -->
	<link rel="stylesheet" href="{{ asset('blog_template') }}/{{ asset('blog_template') }}/fonts/flaticon/font/flaticon.css">
					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
                                ...
                                @endguest
                                @auth
                                    <li class="btn-cta"><a href="{{ route('login') }}"><span>Ahmed</span></a></li>
                                @endauth
							</ul>
						</div>
					</div>
