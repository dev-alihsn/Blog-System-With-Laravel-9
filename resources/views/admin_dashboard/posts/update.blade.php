					    ...
					    <div class="row">
                           ...
                           <div class="border border-3 p-4 rounded">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter post title" name="title" value="{{$post->title}}">
                                @error('title')
                              ...
                              <div class="mb-3">
								...
								<input type="text" class="form-control" id="inputProductTitle" placeholder="Enter post slug" name="slug" value="{{$post->slug}}">
                                @error('slug')
                                    <small class="error text-danger">{{$message}}</small>
                                @enderror
							  </div>
							  <div class="mb-3">
								...
								<textarea class="form-control" id="inputProductDescription" rows="3" name="excerpt">{{$post->excerpt}}</textarea>
                                @error('excerpt')
                                    <small class="error text-danger">{{$message}}</small>
                                @enderror
							  </div>
                                        ...
                                        <div class=" p-3 ">
                                            <div class="mb-3">
                                                <select class="single-select" name="category">
                                                    ...
                                                    <option value="{{$id}}" {{$id === $post->category_id ? 'selected' : ''}} >{{$category}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-center">
                                        <img src="{{asset('storage'). '/' . $post->image->path}}" style="max-width:300px;height:300px;" alt="post thumbnail">
                                    </div>
                                </div>
							  </div>
                              <div class="mb-3">
