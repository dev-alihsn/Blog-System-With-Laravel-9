                    ...
                    <div class="row">
                       ...
                       <div class="border border-3 p-4 rounded">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="inputProductTitle" placeholder="Enter post title" name="name" value="{{old("name",$category->name)}}">
                            @error('name')
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="inputProductTitle" placeholder="Enter post slug" name="slug" value="{{old('slug',$category->slug)}}">
                            @error('slug')
                                <small class="error text-danger">{{$message}}</small>
                            @enderror
                          </div>
