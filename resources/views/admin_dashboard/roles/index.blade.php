									...
									<tr>
										...
										<td>
											<div class="d-flex order-actions">
                                                ...
                                                <form action="{{route('admin.roles.destroy',$role)}}" method="POST" id="delete_form_{{$role->id}}">@csrf @method('DELETE')</form>
												<a href="#" onclick="this.preventDefualt;document.getElementById('delete_form_{{$role->id}}').submit()" class="ms-3"><i class='bx bxs-trash'></i></a>
											</div>
										</td>
									</tr>
                                    @endforeach
