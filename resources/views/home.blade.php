			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
			            ...
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-1.jpg);"></a>
			            <div class="text">
			         ...
			         <div class="block-21 d-flex animate-box">
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-2.jpg);"></a>
			            <div class="text">
			               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
			               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
			               <div class="meta">
			         ...
			         <div class="block-21 d-flex animate-box">
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/{{ asset('blog_template') }}/images/blog-3.jpg);"></a>
			            <div class="text">
			               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
			               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
			               <div class="meta">
			         ...
			         <div class="block-21 d-flex animate-box">
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-4.jpg);"></a>
			            <div class="text">
			               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
			               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
			               <div class="meta">
			         ...
			         <div class="block-21 d-flex animate-box">
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-5.jpg);"></a>
			            <div class="text">
			               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
			               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
			               <div class="meta">
			         ...
			         <div class="block-21 d-flex animate-box">
			            <a href="#" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-6.jpg);"></a>
			            <div class="text">
			               <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
			               <p>ven the all-powerful Pointing has no control about the blind texts it is an almost</p>
			               <div class="meta">
					...
					<div class="col-md-4 animate-box">
						<div class="sidebar">
							...
							<div class="side">
								...
								<div class="f-blog">
									<a href="blog.html" class="blog-img" style="background-image: url({{ asset('blog_template') }}/images/blog-3.jpg);">
									</a>
									<div class="desc">
										<p class="admin"><span>18 April 2018</span></p>
										<h2><a href="blog.html">Creating Mobile Apps</a></h2>
